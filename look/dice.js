...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e66f708f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e66f708f');}
...
function clearFlash(){dieView.classList.remove('rl-win-e66f708f');dieView.classList.remove('rl-lose-e66f708f');if(frameEl){frameEl.classList.remove('rl-win-e66f708f');frameEl.classList.remove('rl-lose-e66f708f');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-e66f708f');if(frameEl){frameEl.classList.add('rl-win-e66f708f');}}else{dieView.classList.add('rl-lose-e66f708f');if(frameEl){frameEl.classList.add('rl-lose-e66f708f');}}
...
var brandEl=document.querySelector('.rl-brand-e66f708f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
